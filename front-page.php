...
<div class="spinner-wrapper">
        ...
        <div class="comingSoon">
            ...
            <div><img class="aboutLogoComingSoon" src="<?php bloginfo('template_url'); ?>/assets/title.png"/></div>
            <div class="aboutTextContainer">
                <div class="aboutTitleComingSoon">We're coming Soon...</div>
                <div class="aboutLogoComingSoon1">a home and creative studio built on Filipino and Japanese sensibilities.</div>
            </div>

            <div class="row g-0">

            <div class="col-md-6">
            <div class="d-md-flex aboutContent1 align-items-sm-center">
            <div class="aboutContent1Header">Mission</div>
            <div class="aboutContent1Subheader">Balay Kobo provides open spaces for photography. By fusing Filipino &amp; Japanese sensibilities, it allows creatives to hone their craft with comfort and clarity</div>
            </div>
            </div>


            <div class="col-md-6">
            <div class="d-md-flex aboutContent2 align-items-sm-center">
            <div class="aboutContent2Header">Vision</div>
            <div class="aboutContent2Subheader">A home &amp; creative studio that elevates and holds space for beauty, embodying the spirit of resilience and collaboration.</div>
            </div>
            </div>


            <div class="col-md-6">
            <div class="d-md-flex aboutContent3 align-items-sm-center"></div>
            </div>


            <div class="col-md-6">
            <div class="aboutContent4">
            <div class="aboutContent4Header">Architecture</div>
            <div class="aboutContent4Subheader">Learn more about what we do.</div>
            <div class="mt-5">
            <div class="btnText">view floor plans</div>
            <div class="btnText">call booking manager</div>
            </div>
            </div>
            </div>
            ...
            <div class="col-md-6">
            <div class="aboutContent4">
            <div class="aboutContent4Header">Interior Design</div>
            <div class="aboutContent4Subheader">Check out our stuff.</div>
            <div class="mt-5">
            <div class="btnText">view online oculars</div>
            <div class="btnText">furniture we used</div>
            </div>
            </div>
            </div>
            ...
            <div class="col-md-6">
            <div class="d-md-flex aboutContent6 align-items-sm-center"></div>
            </div>


            <div class="col-md-6">
            <div class="aboutContent7">
            <div class="aboutContent4Header">Become a partner!</div>
            <div class="aboutContent4Subheader">Want to work with us? We’d love to hear what you have in mind!</div>
            <div class="mt-5">
            <div class="btnText">contact us here</div>
            <div class="btnText">other partnerships</div>
            </div>
            </div>
            </div>
            ...
            <div class="col-md-6">
            <div class="d-md-flex aboutContent8 align-items-sm-center"></div>
            </div>


            <div class="col-md-6">
            <div class="d-md-flex aboutContent9 align-items-sm-center"><iframe style="border: 0;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3864.206440643131!2d121.00312617555939!3d14.4152597815866!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d196a5a901c5%3A0x9fa7cabeb5571313!2s23%20Kamagong%20Rd%2C%20Las%20Pi%C3%B1as%2C%20Metro%20Manila!5e0!3m2!1sen!2sph!4v1704563189693!5m2!1sen!2sph" width="100%" height="100%" allowfullscreen="allowfullscreen"></iframe></div>
            </div>


            <div class="col-md-6">
            <div class="aboutContent10">
            <div class="aboutContent4Header">We’re located in Las Piñas</div>
            <div class="aboutContent4Subheader">Pilar Village, towards the clubhouse</div>
            <div class="mt-5">
            <div class="btnText">contact us here</div>
            <div class="btnText">other partnerships</div>
            </div>
